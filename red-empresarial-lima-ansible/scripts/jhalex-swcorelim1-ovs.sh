...
ovs-vsctl add-bond br-core bond-pcsc1-sd1 ens38 ens39 bond_mode=active-backup lacp=off other_config:bond-primary=ens38
ovs-vsctl add-bond br-core bond-pcsc1-sd2 ens40 ens41 bond_mode=active-backup lacp=off other_config:bond-primary=ens40
