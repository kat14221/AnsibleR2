...
ovs-vsctl add-bond br-core bond-pcsc1-sc2 ens36 ens37 bond_mode=balance-slb lacp=off
ovs-vsctl add-bond br-core bond-pcsc2-sd1 ens38 ens39 bond_mode=balance-slb lacp=off
...
ip addr add 10.255.21.2/30 dev int-core-test

echo "[JHALEX] SWCORELIM2 - OVS configurado correctamente"
echo "[JHALEX] Bridge: br-core | Bonds: sc2, sd1, sd2 | Internal: int-core-test 10.255.21.2/30"