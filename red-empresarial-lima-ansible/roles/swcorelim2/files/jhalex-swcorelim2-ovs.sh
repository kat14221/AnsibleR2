...
# SWCORELIM2: limpiar bonds Core-Distribución antiguos
ovs-vsctl --if-exists del-port bond-pcsc2-sd1 || true
...
ovs-vsctl add-bond br-core bond-pcsc2-sd1 ens38 ens39
ovs-vsctl set port bond-pcsc2-sd1 bond_mode=active-backup
ovs-vsctl set port bond-pcsc2-sd1 lacp=off
ovs-vsctl set port bond-pcsc2-sd1 other_config:bond-primary=ens38
ovs-vsctl set port bond-pcsc2-sd1 trunks=10,20,30,40,50,60,70,80,99

ovs-vsctl add-bond br-core bond-pcsc2-sd2 ens40 ens41
ovs-vsctl set port bond-pcsc2-sd2 bond_mode=active-backup
ovs-vsctl set port bond-pcsc2-sd2 lacp=off
ovs-vsctl set port bond-pcsc2-sd2 other_config:bond-primary=ens40
